...
class IclpClass {
	...
	public function run () {
		...
		switch ($ctrl) {
			case 'page':
				$controller = new \clients\example\sites\xmas\app\controller\PageController();
				break;
			case 'api':
				$controller = new \clients\example\sites\xmas\app\controller\ApiController();
				break;
			case 'admin':
				$controller = new \clients\example\sites\xmas\app\controller\AdminController();
				break;
			case 'report':
				$controller = new \clients\example\sites\xmas\app\controller\ReportController();
				break;
			default:
