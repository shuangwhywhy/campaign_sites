...
class IclpClass {
	...
	public function run () {
		...
		switch ($ctrl) {
			case 'page':
				$controller = new \clients\example\sites\common\app\controller\PageController();
				break;
			case 'api':
				$controller = new \clients\example\sites\common\app\controller\ApiController();
				break;
			case 'admin':
				$controller = new \clients\example\sites\common\app\controller\AdminController();
				break;
			case 'report':
				$controller = new \clients\example\sites\common\app\controller\ReportController();
				break;
			default:
