...
class IclpClass {
	...
	public function run () {
		...
		switch ($ctrl) {
			case 'page':
				$controller = new \clients\example\sites\cny\app\controller\PageController();
				break;
			case 'api':
				$controller = new \clients\example\sites\cny\app\controller\ApiController();
				break;
			case 'admin':
				$controller = new \clients\example\sites\cny\app\controller\AdminController();
				break;
			case 'report':
				$controller = new \clients\example\sites\cny\app\controller\ReportController();
				break;
			default:
