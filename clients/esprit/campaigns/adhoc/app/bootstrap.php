...
class IclpClass {
	...
	public function run () {
		...
		switch ($ctrl) {
			case 'page':
				$controller = new \clients\esprit\campaigns\adhoc\app\controller\PageController();
				break;
			case 'api':
				$controller = new \clients\esprit\campaigns\adhoc\app\controller\ApiController();
				break;
			case 'admin':
				$controller = new \clients\esprit\campaigns\adhoc\app\controller\AdminController();
				break;
			case 'report':
				$controller = new \clients\esprit\campaigns\adhoc\app\controller\ReportController();
				break;
			default:
