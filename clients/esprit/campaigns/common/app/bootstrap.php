...
class IclpClass {
	...
	public function run () {
		...
		switch ($ctrl) {
			case 'page':
				$controller = new \clients\esprit\campaigns\common\app\controller\PageController();
				break;
			case 'api':
				$controller = new \clients\esprit\campaigns\common\app\controller\ApiController();
				break;
			case 'admin':
				$controller = new \clients\esprit\campaigns\common\app\controller\AdminController();
				break;
			case 'report':
				$controller = new \clients\esprit\campaigns\common\app\controller\ReportController();
				break;
			default:
